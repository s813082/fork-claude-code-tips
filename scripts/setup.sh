...
echo "  1. DX plugin - skills like /dx:gha, /dx:handoff, and reddit-fetch"
echo ""
...
echo "  5. Read(~/.claude) permission - allows the half-clone command to read conversation history"
